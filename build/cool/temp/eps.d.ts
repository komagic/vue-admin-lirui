declare namespace Eps {
	...
	interface CustomerOrdersEntity {
		/**
		 * ID
		 */
		id?: number;
	...
	interface CustomerRecordsEntity {
		/**
		 * ID
		 */
		id?: number;
	...
	interface CustomerOrder_data {
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<CustomerOrdersEntity>;
		/**
		 * 分页查询
		 */
		page(data?: any): Promise<{
			pagination: { size: number; page: number; total: number };
			list: CustomerOrdersEntity[];
			[key: string]: any;
		}>;
		/**
		 * 新增
		 ...
		 * list
		 */
		list(data?: any): Promise<CustomerOrdersEntity[]>;
		/**
		 * 权限标识
		 */
		permission: {
	...
	interface CustomerProduct_ratio {
		/**
		 * 删除
		 */
		delete(data?: any): Promise<any>;
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<ProductRatioEntity>;
		/**
		 * 列表查询
		 */
		list(data?: any): Promise<ProductRatioEntity[]>;
		/**
		 * 分页查询
		 */
		page(data?: any): Promise<{
			pagination: { size: number; page: number; total: number };
			list: ProductRatioEntity[];
			[key: string]: any;
		}>;
		/**
		 * 新增
	...
	interface CustomerRecords {
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<CustomerRecordsEntity>;
		/**
		 * 分页查询
		 */
		page(data?: any): Promise<{
			pagination: { size: number; page: number; total: number };
			list: CustomerRecordsEntity[];
			[key: string]: any;
		}>;
		/**
		 * 新增
		 ...
		 * list
		 */
		list(data?: any): Promise<CustomerRecordsEntity[]>;
		/**
		 * 权限标识
		 */
		permission: {
	...
	type Service = {
		...
		customer: {
			order_data: CustomerOrder_data;
			orders: CustomerOrders;
			product_ratio: CustomerProduct_ratio;
